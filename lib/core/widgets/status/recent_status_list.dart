...
class RecentStatusList extends StatelessWidget {
  final List<StatusModel> statuses;
  const RecentStatusList({super.key, required this.statuses});

  @override
  Widget build(BuildContext context) {
    if (statuses.isEmpty) {
      return const Center(child: Text('لا توجد حالات حديثة'));
    }
